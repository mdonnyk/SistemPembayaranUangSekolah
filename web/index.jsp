...
<%
            SimpleDateFormat fmt = new SimpleDateFormat("yyyy-MM-dd-HH-mm");
                ...
                Date date2 = null;
            try {
                date1 = fmt.parse("2016-10-24-12-27"); //Waktu untuk mengirim pemberitahuan
                date2 = fmt.parse("2016-10-24-12-08"); //Waktu untuk membuat tagihan
                ...
                //time1.schedule(p, date1); //Pemberitahuan
               // time2.schedule(t, date2); //Tagihan
